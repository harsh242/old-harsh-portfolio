...
export default function Hero() {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center order-last">
      ...
      <p class="mb-8 leading-relaxed text-2l">A Passionate Problem Solver before a Designer. I combine my creative and problem solving skills to give out what's best for the Product.<br/><a href="#about" className="text-indigo-500"> Know me More</a> </p>
